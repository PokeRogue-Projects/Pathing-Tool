...
import { allAbilities, applyAbAttrs, applyPostBattleInitAbAttrs, BlockItemTheftAbAttr, DoubleBattleChanceAbAttr, PostBattleInitAbAttr, SyncEncounterNatureAbAttr } from "#app/data/ability";
...
export default class BattleScene extends SceneBase {
  ...
  * - false: Show hints for moves
   ...
   *
   * This calls Battle.randSeedInt(`scene`, {@linkcode range}, {@linkcode min}) in `src/battle.ts`
